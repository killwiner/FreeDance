...
QT_MOC_LITERAL(3, 38, 10), // "nextSignal"
QT_MOC_LITERAL(4, 49, 9) // "next_step"

    },
    "rendering::TestsOpenglR\0test_timeout\0"
    "\0nextSignal\0next_step"
};
...
void rendering::TestsOpenglR::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TestsOpenglR::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TestsOpenglR::nextSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void rendering::TestsOpenglR::nextSignal()
{
