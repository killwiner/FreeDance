...
Vect<float> Head::first_search() {
    ...
    for(float y = 0; y < HEIGHT; ++y) {
        ...
        if(every_m_lines(top, n_top_x, y, web_width, num_webs, start, top_flag, right, left, right_last_x, left_last_x, web_surface, web_surface_last, bottom, n_bottom_x, neck))
             return neck;
